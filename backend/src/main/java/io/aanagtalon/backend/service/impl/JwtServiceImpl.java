...
import io.aanagtalon.backend.function.TriConsumer;
...
import static io.aanagtalon.backend.enumeration.TokenType.REFRESH;
...
public class JwtServiceImpl extends JwtConfiguration implements JwtService {
    ...
    public Function<String, List<GrantedAuthority>> authorities = token ->
            commaSeparatedStringToAuthorityList(new StringJoiner(AUTHORITY_DELIMITER)
                    .add(claimsFunction.apply(token).get(AUTHORITIES, String.class)).toString());
